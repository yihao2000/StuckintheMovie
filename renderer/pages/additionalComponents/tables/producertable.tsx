  ...
  return (
    <div className={classes.root}>
      <div className={classes.demo1}>
        ...
        {value == 0 && (
          <ProducerDetailTable selectedProducer={props.producerDetail} />
        )}

        {value == 1 && (
          <ProducerMovieTab selectedProducer={props.producerDetail} />
        )}
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof Producer) => (event: React.MouseEvent<unknown>) => {
...
export default function ProducerTable(props: Parameter) {
  const classes = useStyles();
  const [order, setOrder] = React.useState<Order>("desc");
  const [orderBy, setOrderBy] = React.useState<keyof Producer>("id");
      ...
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {stableSort(producers, getComparator(order, orderBy)).map(
                (row, index) => {
          ...
          >
            ...
            <DialogContent>
              <CustomizedTabs
                producerDetail={selectedProducer}
