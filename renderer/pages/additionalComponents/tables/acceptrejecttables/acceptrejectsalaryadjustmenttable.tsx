...
export default function AcceptRejectSalaryAdjustmentTable(props: Props) {
  ...
  const handleOpenActionConfirmation = async () => {
    if (action == "Accept") {
      acceptSelectedSalaryAdjustment(selectedSalaryAdjustment.id);
    } else if (action == "Reject") {
      rejectSelectedSalaryAdjustment(selectedSalaryAdjustment.id);
    }
    setUpdating(true);
            ...
            <DialogContent style={{ paddingBottom: 0 }}>
              <DialogContentText style={{ color: "black" }} component="div">
                <Typography component="span">
                  ...
                  selected Salary Adjustment !
                </Typography>
                <Box style={{ height: 5 }}></Box>

                <Typography variant="subtitle2" style={{ color: "grey" }}>
                  Warning: This employee salary will be adjusted according to
