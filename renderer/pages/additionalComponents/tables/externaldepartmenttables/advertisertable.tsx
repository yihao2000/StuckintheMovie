...
import { AdvertiserTab } from "../../tabpage/advertisertab";
import AdvertiserDetailTable from "./advertiserdetailtable";
    ...
    <div className={classes.root}>
      <div className={classes.demo1}>
        <AntTabs value={value} onChange={handleChange} aria-label="ant example">
          ...
          <AntTab label="Advertisement" />
        </AntTabs>

        {value == 0 && (
          <AdvertiserDetailTable selectedAdvertiser={props.advertiserDetail} />
        )}

        {value == 1 && (
          <AdvertiserTab selectedAdvertiser={props.advertiserDetail} />
        )}
...
export default function AdvertiserTable(props: Parameter) {
  const classes = useStyles();
  ...
  React.useEffect(() => {
    queryAdvertisers().then((e) => [setAdvertisers(e)]);
  }, [props.refresh]);
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={advertisers.length}
            />
            <TableBody>
              {stableSort(advertisers, getComparator(order, orderBy)).map(
                (row, index) => {
          ...
          >
            ...
            <DialogContent>
              <CustomizedTabs
                advertiserDetail={selectedAdvertiser}
