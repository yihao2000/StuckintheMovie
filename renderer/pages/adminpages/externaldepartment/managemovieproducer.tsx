...
import { Producer } from "../../additionalComponents/interfaces/interface";
...
function Inventory() {
  ...
  const [producerDescription, setProducerDescription] = React.useState("");
  const [producerEmail, setProducerEmail] = React.useState("");
  const [producerPhone, setProducerPhone] = React.useState("");
  ...
  const handleConfirmInserting = () => {
    ...
    queryProducerAmount().then((e) => {
      var data: Producer = {
        id: "MP-" + e.toLocaleString().padStart(3, "0"),
        name: producerName,
      ...
      insertProducer(data).then(async () => {
  ...
  const handleDescriptionChange = (
    ...
    setProducerDescription(event.target.value);
  };
  ...
  const handleEmailChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setProducerEmail(event.target.value);
  };
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Manage Movie Producers</title>
      </Head>
      <div className={classes.root}>
        <CssBaseline />
        <PrimarySearchAppBar />
          ...
          >
            ...
            <DialogContent>
              ...
              <DialogContentText style={{ marginTop: "20px", marginBottom: 0 }}>
                Notes: Submitted Producer Detail will be recorded as the company
                producer !
              </DialogContentText>
            </DialogContent>
