...
function Inventory() {
  ...
  const handleConfirmInserting = () => {
    ...
    querySupplierAmount().then((e) => {
      var data: Supplier = {
        id: "MS-" + e.toLocaleString().padStart(3, "0"),
        name: supplierName,
      ...
      insertSupplier(data).then(async () => {
  ...
  const handleDescriptionChange = (
    ...
    setSupplierDescription(event.target.value);
  };
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Manage Menu Suppliers</title>
      </Head>
      <div className={classes.root}>
        <CssBaseline />
        <PrimarySearchAppBar />
          ...
          >
            ...
            <DialogContent>
              ...
              <DialogContentText style={{ marginTop: "20px", marginBottom: 0 }}>
                Notes: Submitted Supplier Detail will be recorded as the company
                supplier !
              </DialogContentText>
            </DialogContent>
